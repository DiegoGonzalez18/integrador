...
<div id="menu-principal" class="header-v6 header-white-transparent header-sticky" style="position: relative;">
        ...
        <ul class="breadcrumb no-padding margin-bottom-10">
                              <li title="Ingresar a Inicio"><a href="/" style="font-style: italic; font-size: 14px;">Inicio</a></li>
                                         <li title="Universidad"><a href="/" style="font-style: italic; font-size: 14px;">Secretaría</a></li>
                                          <li class="active" title="Admisiones y Registro Académico" style="font-style: italic; font-size: 14px;">Eventos</li>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="shadow-wrapper">
                    ...
                    <div class="margin-top-20"><h2 style="color:#AA1916;"><b>Información del Evento</b></h2></div>
  ...
  <li style="border:none;"><a href="#"
    ...
    <i class="fa fa-angle-double-right" aria-hidden="true"></i> Lugar :  <br>{!! $evento['lugar'] !!}</a></li>
    <li style="border:none;"><a href="#"
        class="text-submenu" style="border:none; border-bottom: 1px solid #DDDEDF;">
        <i class="fa fa-angle-double-right" aria-hidden="true"></i> Fecha :  <br>{!! $evento['Fecha'] !!}</a></li>
            ...
            <div class="col-md-8 mb-margin-bottom-30">
                                <small class="pull-right" style="color:#aa1916;"><i class="fa fa-calendar"></i> {{$evento['Fecha']}}</small>
                            <div class="margin-bottom-40">

                                        <div class="headline margin-bottom-30"><h1>Contenido</h1></div>
