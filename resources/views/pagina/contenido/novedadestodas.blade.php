            ...
            <ul class="breadcrumb no-padding margin-bottom-10">
                                  <li title="Ingresar a Inicio"><a href="/" style="font-style: italic; font-size: 14px;">Inicio</a></li>
                                             <li title="Universidad"><a href="/" style="font-style: italic; font-size: 14px;">Secretaría</a></li>
                                              <li class="active" title="Admisiones y Registro Académico" style="font-style: italic; font-size: 14px;">Novedades</li>
    ...
    <tbody>
            ...
            @for($i = $c-1; $i >=0; $i--)
                ...
                <td>
                    <div class="row">
                        <div class="col-md-12">
                             <h4 style="text-transform: none;"><a href="novedad/{{$novedades[$i]['id']}}"><b>{{$novedades[$i]['titulo']}}</b></a></h4>
