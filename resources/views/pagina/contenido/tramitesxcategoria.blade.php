            ...
            <ul class="breadcrumb no-padding margin-bottom-10">
                                  <li title="Ingresar a Inicio"><a href="#" style="font-style: italic; font-size: 14px;">Inicio</a></li>
                                             <li title="Universidad"><a href="#" style="font-style: italic; font-size: 14px;">Secretaría</a></li>
                                              <li class="active" title="Trámites" style="font-style: italic; font-size: 14px;">Trámites</li>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12" style="border-bottom: 1px solid #aa1916;">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                                ...
                                <b>Los Trámites de  la Categoría {{ $cat ?? '' }}</b></h1>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-sm-6">
                                <div class="card">
                                        ...
                                        <div class="card-block">
                                          <h3 class="card-title">{{$tramites[$i]['titulo']}}</h3>

                                          <a href="/tramite/{{$tramites[$i]['id']}}" class="btn btn-primary">Ver más</a>
                                        </div>
                                      </div>
