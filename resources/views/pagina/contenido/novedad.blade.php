                ...
                <ul class="breadcrumb no-padding margin-bottom-10">
                                      ...
                                      <li title="Ingresar a Inicio"><a href="/" style="font-style: italic; font-size: 14px;">Inicio</a></li>
                                                 <li title="Universidad"><a href="/" style="font-style: italic; font-size: 14px;">Secretaría</a></li>
                                                  <li class="active" title="Admisiones y Registro Académico" style="font-style: italic; font-size: 14px;">Novedad</li>
        ...
        <div class="row">
           <!--/col-md-3-->
            <div class="col-md-12 mb-margin-bottom-30">
                                <small class="pull-right" style="color:#aa1916;"><i class="fa fa-calendar"></i> {{$novedad['updated_at']}}</small>
                            <div class="margin-bottom-40">

                                        <div class="headline margin-bottom-30"><h1>Contenido</h1></div>

                                      {!! $novedad['description'] !!}
                                        <embed src="../{{$novedad['url'] }}" type="application/pdf" width="100%" height="600px" />
