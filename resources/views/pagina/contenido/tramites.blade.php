...
<div id="menu-principal" class="header-v6 header-white-transparent header-sticky" style="position: relative;">
    ...
    <div class="container">
            ...
            <ul class="breadcrumb no-padding margin-bottom-10">
                                  <li title="Ingresar a Inicio"><a href="#" style="font-style: italic; font-size: 14px;">Inicio</a></li>
                                             <li title="Universidad"><a href="#" style="font-style: italic; font-size: 14px;">Secretaría</a></li>
                                              <li class="active" title="Tramites" style="font-style: italic; font-size: 14px;">Trámites</li>
        ...
        <!--=== fin breadcrumb ===-->
                ...
                <div class="col-md-12 col-sm-12 col-xs-12" style="border-bottom: 1px solid #aa1916;">
                    <!--            <h1 class="pull-left text-parallax capa-image2" style="background-color: #aa1916;color: #fff; margin-top: 0px; margin-bottom: 0px; padding: 6px; padding-left: 15px; padding-right: 15px;">-->
                    <div class="row">
                        <div class="col-md-10">
                                                <h1 class="" style="font-size: 16px;">
                                <b>Los Trámites estan organizados por Categorías</b></h1>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-sm-6">
                                <div class="card">
                                        ...
                                        <div class="card-block">
                                          <h3 class="card-title">{{$cat[$i]['nombre']}}</h3>
                                          <p class="card-text">{{$cat[$i]['description']}}.</p>
                                          <a href="tramitescategoria/{{$cat[$i]['id']}}" class="btn btn-primary">Ver los Trámites</a>
                                        </div>
                                      </div>
