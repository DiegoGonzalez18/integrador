    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Archivo
                ...
                <table class="table table-bordered table-striped table-sm">
                    ...
                    <tbody>
                        <tr v-for="slider in arraySlider" :key="slider.id" >
                            ...
                            <td ><a  :href="slider.url" alt="">Archivo</a></td>
                ...
                <div class="modal-body">
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" v-model="titulo" class="form-control" placeholder="Nombre del Archivo" >
                                <span class="help-block">(*) Ingrese el nombre del archivo</span>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="col-md-3 form-control-label" for="file-input" required >Archivo</label>
                            <div class="col-md-9">
...
const axios= require('axios');
    export default {
       ...
       methods:{
           listarSlider(page,buscar){
               var url="admin/archivo?page="+page + "&buscar="+buscar;
  ...
  if (result.value) {
      axios.post('admin/archivo/deletedArchivo',{
    ...
    me.listarSlider(1,'');
                        ...
                        swal.fire(
      'Error!',
      'Tu Archivo no puede ser borrado. El archivo ya ha sido asignado',
      'error'
    );
                })
        ...
        ,registrarSlider(){
                                ...
                                swal.fire('Falta ingresar el archivo','','error');

                                }else{
                                axios.post('admin/archivo/registerArchivo',{
                                    'algo':this.image,
                                    'titulo':this.titulo
                                }).then(function(response){
                                        console.log(response.data)
                                     swal.fire('Archivo registrado','','success');
                                    me.listarSlider(1,'');
                                    me.cerrarModal();
            ...
            let me =this;
            if(this.titulo==''){
                            swal.fire('Falta ingresar el nombre','','error');
            }else{
                axios.post('admin/archivo/updateArchivo',{
                    'algo':this.image,
                    'titulo': this.titulo,
                    'id':this.id,
                        ...
                        console.log(response.data)
                         ...
                         swal.fire('Archivo Actualizado','','success');
                                    me.listarSlider(1,'');
                                    me.cerrarModal();}
                }).catch(function(error){
                    console.log(error);
