    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Trámite
                ...
                <div class="modal-body boxContenedor">
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" v-model="titulo" class="form-control" placeholder="Titulo del Trámite" >
                                <span class="help-block">(*) Ingrese el titulo del trámite</span>
                            </div>
                        </div>
                        <div  class="form-group row" v-if="categorias!=null">
                            <label class="col-md-3 form-control-label" for="text-input">Categoría</label>
                            <div class="col-md-9">
                        <select class="custom-select" v-model="categoria" >

                                    <option v-for="slider in categorias" :key="slider.id" :value="slider.id"  v-text="slider.nombre"></option>
...
import { VueEditor } from "vue2-editor";
    export default {
       ...
       methods:{
           listarSlider(page,buscar){
               var url="admin/tramite?page="+page + "&buscar="+buscar;
  ...
  if (result.value) {
      axios.post('admin/tramite/deletedTramite',{
    ...
    me.listarSlider(1,'');
            ...
            ,registrarSlider(){
                                ...
                                axios.post('admin/tramite/registerTramite',{
            ...
            if(this.titulo==''){
                ...
                axios.post('admin/tramite/updatedTramite',{
                    ...
                    'id':this.id,
                        ...
                        console.log(response.data)
                         swal.fire('Trámite Actualizado','','success');
                                    me.listarSlider(1,'');
                                    me.cerrarModal();
                }).catch(function(error){
                    console.log(error);
                                ...
                                case "slider":
                                    {
                                        switch(accion){
                                            case 'registrar':
                                                {
                                                    this.modal=1;
                                                    this.tituloModal='Registrar Trámite';
                                                    this.titulo='';
                                                    this.url='';
                                                    this.boton=1;
                                            ...
                                            case 'actualizar':
                                                {
                                                    this.modal=1;
                                                    this.tituloModal='Actualizar Trámite';
                                                    this.boton=2;
