   ...
   <main class="main ">
                ...
                <table class="table table-bordered table-striped table-sm">
                    ...
                    <tbody>
                        <tr v-for="slider in arraySlider" :key="slider.id" >
                            ...
                            <td v-text="slider.description"></td>
    ...
    <div class="modal fade"  tabindex="-1" :class="{'mostrar':modal}" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-primary modal-lg" role="document">
            <div class="modal-content "  id="categoria" style="  height: 300px;">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="form-group row">
                         <label class="col-md-3 form-control-label" for="text-input">Descripcion</label>
                            <div class="col-md-9">
                                <textarea type="text" v-model="descripcion" class="form-control" placeholder="descripcion" ></textarea>
                                <span class="help-block">(*)Una breve descripcion</span>
                            </div>
                        </div>
...
import { VueEditor } from "vue2-editor";
    export default {
       ...
       methods:{
           listarSlider(page,buscar){
               var url="admin/categoria?page="+page + "&buscar="+buscar;
  ...
  if (result.value) {
      axios.post('admin/categoria/deletedCategoria',{
    ...
    me.listarSlider(1,'');
                                  ...
                                  swal.fire(
      'Error!',
      'No puede borrarla. Ya existen trámites de esta categoría.',
      'success'
    );
                })
        ...
        ,registrarSlider(){
                                ...
                                axios.post('admin/categoria/registerCategoria',{
                                    'algo':this.image,
                                    'titulo':this.titulo,
            ...
            if(this.titulo==''){
                ...
                axios.post('admin/categoria/updateCategoria',{
